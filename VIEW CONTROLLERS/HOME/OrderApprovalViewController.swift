...
class OrderApprovalViewController: CommonViewController
{
    ...
    func orderApprovalContent()
    {
        ...
        PricingButton.frame = CGRect(x: 0, y: orderApprovalNavigationBar.frame.maxY, width: ((view.frame.width / 2) - 1), height: 50)
        ...
        DeliveryDetailsButton.frame = CGRect(x: PricingButton.frame.maxX + 1, y: orderApprovalNavigationBar.frame.maxY, width: view.frame.width / 2, height: 50)
    ...
    */
    ...
    func PricingViewContents(isHidden : Bool)
    {
        ...
        DressDetView.frame = CGRect(x: x + 15 , y: DeliveryDetailsButton.frame.maxY + y, width: view.frame.width - (5 * x), height: (12 * y))
